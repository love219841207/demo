...
<head>
    ...
    <link rel="stylesheet" href="${rc.contextPath}/css/style.min.css">
    <link rel="stylesheet" href="${rc.contextPath}/css/iconfont.css">
    <link rel="stylesheet" href="${rc.contextPath}/js/validator-0.7.3/jquery.validator.css">
    <link rel="stylesheet" href="${rc.contextPath}/css/sweetalert/sweetalert.css">
    <script src="${rc.contextPath}/js/jquery-1.8.3.js"></script>
    <script type="text/javascript" src="${rc.contextPath}/js/validator-0.7.3/jquery.validator.js"></script>
    <script type="text/javascript" src="${rc.contextPath}/js/validator-0.7.3/local/zh_CN.js"></script>
    <script type="text/javascript" src="${rc.contextPath}/js/host.js"></script>
    <script type="text/javascript" src="${rc.contextPath}/js/sweetalert/sweetalert.min.js"></script>
</head>
<body bgcolor="#FFFFFF">

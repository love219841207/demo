...
import com.cookie.home.util.MyDES;
import com.cookie.sso.service.inter.SysPermissionService;
...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		SysUser user = null;*/
		// 从数据库获取对应用户名密码的用户
		List<SysUser> userList = sysUserService.selectByMap(user);
		if(userList.size()!=0){
			user = userList.get(0);
		}
		if (null == user) {
